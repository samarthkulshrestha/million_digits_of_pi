...
namespace Calculate_Pi {
    ...
    void fft_pointwise(complex < double > * T,
        const complex < double > * A, int k) {
    ...
    void int_to_fft(complex < double > * T, int k,
        const uint32_t * A, size_t AL) {
    ...
    class BigFloat {
        ...
        private: bool sign; //  true = positive or zero, false = negative
    ...
    void Pi(size_t digits) {
        ...
        /* cout << P.to_string(digits) << endl << endl; */
        cout << "done" << endl;
    }
} //  Namespace: Calculate_Pi
